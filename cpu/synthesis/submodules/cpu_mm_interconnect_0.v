...
module cpu_mm_interconnect_0 (
		...
		output wire [1:0]  wr_addr_pio_s1_address,                  //                    wr_addr_pio_s1.address
		output wire        wr_addr_pio_s1_write,                    //                                  .write
		input  wire [31:0] wr_addr_pio_s1_readdata,                 //                                  .readdata
		output wire [31:0] wr_addr_pio_s1_writedata,                //                                  .writedata
		output wire        wr_addr_pio_s1_chipselect,               //                                  .chipselect
		output wire [1:0]  wr_data_pio_s1_address,                  //                    wr_data_pio_s1.address
		output wire        wr_data_pio_s1_write,                    //                                  .write
		input  wire [31:0] wr_data_pio_s1_readdata,                 //                                  .readdata
		output wire [31:0] wr_data_pio_s1_writedata,                //                                  .writedata
		output wire        wr_data_pio_s1_chipselect,               //                                  .chipselect
		output wire [1:0]  wr_in_flags_s1_address,                  //                    wr_in_flags_s1.address
		input  wire [31:0] wr_in_flags_s1_readdata,                 //                                  .readdata
		output wire [2:0]  wr_out_flags_s1_address,                 //                   wr_out_flags_s1.address
		output wire        wr_out_flags_s1_write,                   //                                  .write
		input  wire [31:0] wr_out_flags_s1_readdata,                //                                  .readdata
		output wire [31:0] wr_out_flags_s1_writedata,               //                                  .writedata
		output wire        wr_out_flags_s1_chipselect               //                                  .chipselect
	);
	...
	wire  [31:0] wr_data_pio_s1_agent_m0_readdata;                                          // wr_data_pio_s1_translator:uav_readdata -> wr_data_pio_s1_agent:m0_readdata
	wire         wr_data_pio_s1_agent_m0_waitrequest;                                       // wr_data_pio_s1_translator:uav_waitrequest -> wr_data_pio_s1_agent:m0_waitrequest
	wire         wr_data_pio_s1_agent_m0_debugaccess;                                       // wr_data_pio_s1_agent:m0_debugaccess -> wr_data_pio_s1_translator:uav_debugaccess
	wire  [16:0] wr_data_pio_s1_agent_m0_address;                                           // wr_data_pio_s1_agent:m0_address -> wr_data_pio_s1_translator:uav_address
	wire   [3:0] wr_data_pio_s1_agent_m0_byteenable;                                        // wr_data_pio_s1_agent:m0_byteenable -> wr_data_pio_s1_translator:uav_byteenable
	wire         wr_data_pio_s1_agent_m0_read;                                              // wr_data_pio_s1_agent:m0_read -> wr_data_pio_s1_translator:uav_read
	wire         wr_data_pio_s1_agent_m0_readdatavalid;                                     // wr_data_pio_s1_translator:uav_readdatavalid -> wr_data_pio_s1_agent:m0_readdatavalid
	wire         wr_data_pio_s1_agent_m0_lock;                                              // wr_data_pio_s1_agent:m0_lock -> wr_data_pio_s1_translator:uav_lock
	wire  [31:0] wr_data_pio_s1_agent_m0_writedata;                                         // wr_data_pio_s1_agent:m0_writedata -> wr_data_pio_s1_translator:uav_writedata
	wire         wr_data_pio_s1_agent_m0_write;                                             // wr_data_pio_s1_agent:m0_write -> wr_data_pio_s1_translator:uav_write
	wire   [2:0] wr_data_pio_s1_agent_m0_burstcount;                                        // wr_data_pio_s1_agent:m0_burstcount -> wr_data_pio_s1_translator:uav_burstcount
	wire         wr_data_pio_s1_agent_rf_source_valid;                                      // wr_data_pio_s1_agent:rf_source_valid -> wr_data_pio_s1_agent_rsp_fifo:in_valid
	wire  [95:0] wr_data_pio_s1_agent_rf_source_data;                                       // wr_data_pio_s1_agent:rf_source_data -> wr_data_pio_s1_agent_rsp_fifo:in_data
	wire         wr_data_pio_s1_agent_rf_source_ready;                                      // wr_data_pio_s1_agent_rsp_fifo:in_ready -> wr_data_pio_s1_agent:rf_source_ready
	wire         wr_data_pio_s1_agent_rf_source_startofpacket;                              // wr_data_pio_s1_agent:rf_source_startofpacket -> wr_data_pio_s1_agent_rsp_fifo:in_startofpacket
	wire         wr_data_pio_s1_agent_rf_source_endofpacket;                                // wr_data_pio_s1_agent:rf_source_endofpacket -> wr_data_pio_s1_agent_rsp_fifo:in_endofpacket
	wire         wr_data_pio_s1_agent_rsp_fifo_out_valid;                                   // wr_data_pio_s1_agent_rsp_fifo:out_valid -> wr_data_pio_s1_agent:rf_sink_valid
	wire  [95:0] wr_data_pio_s1_agent_rsp_fifo_out_data;                                    // wr_data_pio_s1_agent_rsp_fifo:out_data -> wr_data_pio_s1_agent:rf_sink_data
	wire         wr_data_pio_s1_agent_rsp_fifo_out_ready;                                   // wr_data_pio_s1_agent:rf_sink_ready -> wr_data_pio_s1_agent_rsp_fifo:out_ready
	wire         wr_data_pio_s1_agent_rsp_fifo_out_startofpacket;                           // wr_data_pio_s1_agent_rsp_fifo:out_startofpacket -> wr_data_pio_s1_agent:rf_sink_startofpacket
	wire         wr_data_pio_s1_agent_rsp_fifo_out_endofpacket;                             // wr_data_pio_s1_agent_rsp_fifo:out_endofpacket -> wr_data_pio_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> wr_data_pio_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> wr_data_pio_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // wr_data_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> wr_data_pio_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> wr_data_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> wr_data_pio_s1_agent:cp_endofpacket
	wire  [31:0] wr_addr_pio_s1_agent_m0_readdata;                                          // wr_addr_pio_s1_translator:uav_readdata -> wr_addr_pio_s1_agent:m0_readdata
	wire         wr_addr_pio_s1_agent_m0_waitrequest;                                       // wr_addr_pio_s1_translator:uav_waitrequest -> wr_addr_pio_s1_agent:m0_waitrequest
	wire         wr_addr_pio_s1_agent_m0_debugaccess;                                       // wr_addr_pio_s1_agent:m0_debugaccess -> wr_addr_pio_s1_translator:uav_debugaccess
	wire  [16:0] wr_addr_pio_s1_agent_m0_address;                                           // wr_addr_pio_s1_agent:m0_address -> wr_addr_pio_s1_translator:uav_address
	wire   [3:0] wr_addr_pio_s1_agent_m0_byteenable;                                        // wr_addr_pio_s1_agent:m0_byteenable -> wr_addr_pio_s1_translator:uav_byteenable
	wire         wr_addr_pio_s1_agent_m0_read;                                              // wr_addr_pio_s1_agent:m0_read -> wr_addr_pio_s1_translator:uav_read
	wire         wr_addr_pio_s1_agent_m0_readdatavalid;                                     // wr_addr_pio_s1_translator:uav_readdatavalid -> wr_addr_pio_s1_agent:m0_readdatavalid
	wire         wr_addr_pio_s1_agent_m0_lock;                                              // wr_addr_pio_s1_agent:m0_lock -> wr_addr_pio_s1_translator:uav_lock
	wire  [31:0] wr_addr_pio_s1_agent_m0_writedata;                                         // wr_addr_pio_s1_agent:m0_writedata -> wr_addr_pio_s1_translator:uav_writedata
	wire         wr_addr_pio_s1_agent_m0_write;                                             // wr_addr_pio_s1_agent:m0_write -> wr_addr_pio_s1_translator:uav_write
	wire   [2:0] wr_addr_pio_s1_agent_m0_burstcount;                                        // wr_addr_pio_s1_agent:m0_burstcount -> wr_addr_pio_s1_translator:uav_burstcount
	wire         wr_addr_pio_s1_agent_rf_source_valid;                                      // wr_addr_pio_s1_agent:rf_source_valid -> wr_addr_pio_s1_agent_rsp_fifo:in_valid
	wire  [95:0] wr_addr_pio_s1_agent_rf_source_data;                                       // wr_addr_pio_s1_agent:rf_source_data -> wr_addr_pio_s1_agent_rsp_fifo:in_data
	wire         wr_addr_pio_s1_agent_rf_source_ready;                                      // wr_addr_pio_s1_agent_rsp_fifo:in_ready -> wr_addr_pio_s1_agent:rf_source_ready
	wire         wr_addr_pio_s1_agent_rf_source_startofpacket;                              // wr_addr_pio_s1_agent:rf_source_startofpacket -> wr_addr_pio_s1_agent_rsp_fifo:in_startofpacket
	wire         wr_addr_pio_s1_agent_rf_source_endofpacket;                                // wr_addr_pio_s1_agent:rf_source_endofpacket -> wr_addr_pio_s1_agent_rsp_fifo:in_endofpacket
	wire         wr_addr_pio_s1_agent_rsp_fifo_out_valid;                                   // wr_addr_pio_s1_agent_rsp_fifo:out_valid -> wr_addr_pio_s1_agent:rf_sink_valid
	wire  [95:0] wr_addr_pio_s1_agent_rsp_fifo_out_data;                                    // wr_addr_pio_s1_agent_rsp_fifo:out_data -> wr_addr_pio_s1_agent:rf_sink_data
	wire         wr_addr_pio_s1_agent_rsp_fifo_out_ready;                                   // wr_addr_pio_s1_agent:rf_sink_ready -> wr_addr_pio_s1_agent_rsp_fifo:out_ready
	wire         wr_addr_pio_s1_agent_rsp_fifo_out_startofpacket;                           // wr_addr_pio_s1_agent_rsp_fifo:out_startofpacket -> wr_addr_pio_s1_agent:rf_sink_startofpacket
	wire         wr_addr_pio_s1_agent_rsp_fifo_out_endofpacket;                             // wr_addr_pio_s1_agent_rsp_fifo:out_endofpacket -> wr_addr_pio_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> wr_addr_pio_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> wr_addr_pio_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // wr_addr_pio_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> wr_addr_pio_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> wr_addr_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> wr_addr_pio_s1_agent:cp_endofpacket
	wire  [31:0] wr_out_flags_s1_agent_m0_readdata;                                         // wr_out_flags_s1_translator:uav_readdata -> wr_out_flags_s1_agent:m0_readdata
	wire         wr_out_flags_s1_agent_m0_waitrequest;                                      // wr_out_flags_s1_translator:uav_waitrequest -> wr_out_flags_s1_agent:m0_waitrequest
	wire         wr_out_flags_s1_agent_m0_debugaccess;                                      // wr_out_flags_s1_agent:m0_debugaccess -> wr_out_flags_s1_translator:uav_debugaccess
	wire  [16:0] wr_out_flags_s1_agent_m0_address;                                          // wr_out_flags_s1_agent:m0_address -> wr_out_flags_s1_translator:uav_address
	wire   [3:0] wr_out_flags_s1_agent_m0_byteenable;                                       // wr_out_flags_s1_agent:m0_byteenable -> wr_out_flags_s1_translator:uav_byteenable
	wire         wr_out_flags_s1_agent_m0_read;                                             // wr_out_flags_s1_agent:m0_read -> wr_out_flags_s1_translator:uav_read
	wire         wr_out_flags_s1_agent_m0_readdatavalid;                                    // wr_out_flags_s1_translator:uav_readdatavalid -> wr_out_flags_s1_agent:m0_readdatavalid
	wire         wr_out_flags_s1_agent_m0_lock;                                             // wr_out_flags_s1_agent:m0_lock -> wr_out_flags_s1_translator:uav_lock
	wire  [31:0] wr_out_flags_s1_agent_m0_writedata;                                        // wr_out_flags_s1_agent:m0_writedata -> wr_out_flags_s1_translator:uav_writedata
	wire         wr_out_flags_s1_agent_m0_write;                                            // wr_out_flags_s1_agent:m0_write -> wr_out_flags_s1_translator:uav_write
	wire   [2:0] wr_out_flags_s1_agent_m0_burstcount;                                       // wr_out_flags_s1_agent:m0_burstcount -> wr_out_flags_s1_translator:uav_burstcount
	wire         wr_out_flags_s1_agent_rf_source_valid;                                     // wr_out_flags_s1_agent:rf_source_valid -> wr_out_flags_s1_agent_rsp_fifo:in_valid
	wire  [95:0] wr_out_flags_s1_agent_rf_source_data;                                      // wr_out_flags_s1_agent:rf_source_data -> wr_out_flags_s1_agent_rsp_fifo:in_data
	wire         wr_out_flags_s1_agent_rf_source_ready;                                     // wr_out_flags_s1_agent_rsp_fifo:in_ready -> wr_out_flags_s1_agent:rf_source_ready
	wire         wr_out_flags_s1_agent_rf_source_startofpacket;                             // wr_out_flags_s1_agent:rf_source_startofpacket -> wr_out_flags_s1_agent_rsp_fifo:in_startofpacket
	wire         wr_out_flags_s1_agent_rf_source_endofpacket;                               // wr_out_flags_s1_agent:rf_source_endofpacket -> wr_out_flags_s1_agent_rsp_fifo:in_endofpacket
	wire         wr_out_flags_s1_agent_rsp_fifo_out_valid;                                  // wr_out_flags_s1_agent_rsp_fifo:out_valid -> wr_out_flags_s1_agent:rf_sink_valid
	wire  [95:0] wr_out_flags_s1_agent_rsp_fifo_out_data;                                   // wr_out_flags_s1_agent_rsp_fifo:out_data -> wr_out_flags_s1_agent:rf_sink_data
	wire         wr_out_flags_s1_agent_rsp_fifo_out_ready;                                  // wr_out_flags_s1_agent:rf_sink_ready -> wr_out_flags_s1_agent_rsp_fifo:out_ready
	wire         wr_out_flags_s1_agent_rsp_fifo_out_startofpacket;                          // wr_out_flags_s1_agent_rsp_fifo:out_startofpacket -> wr_out_flags_s1_agent:rf_sink_startofpacket
	wire         wr_out_flags_s1_agent_rsp_fifo_out_endofpacket;                            // wr_out_flags_s1_agent_rsp_fifo:out_endofpacket -> wr_out_flags_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> wr_out_flags_s1_agent:cp_valid
	wire  [94:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> wr_out_flags_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // wr_out_flags_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> wr_out_flags_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> wr_out_flags_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> wr_out_flags_s1_agent:cp_endofpacket
	wire  [31:0] wr_in_flags_s1_agent_m0_readdata;                                          // wr_in_flags_s1_translator:uav_readdata -> wr_in_flags_s1_agent:m0_readdata
	wire         wr_in_flags_s1_agent_m0_waitrequest;                                       // wr_in_flags_s1_translator:uav_waitrequest -> wr_in_flags_s1_agent:m0_waitrequest
	wire         wr_in_flags_s1_agent_m0_debugaccess;                                       // wr_in_flags_s1_agent:m0_debugaccess -> wr_in_flags_s1_translator:uav_debugaccess
	wire  [16:0] wr_in_flags_s1_agent_m0_address;                                           // wr_in_flags_s1_agent:m0_address -> wr_in_flags_s1_translator:uav_address
	wire   [3:0] wr_in_flags_s1_agent_m0_byteenable;                                        // wr_in_flags_s1_agent:m0_byteenable -> wr_in_flags_s1_translator:uav_byteenable
	wire         wr_in_flags_s1_agent_m0_read;                                              // wr_in_flags_s1_agent:m0_read -> wr_in_flags_s1_translator:uav_read
	wire         wr_in_flags_s1_agent_m0_readdatavalid;                                     // wr_in_flags_s1_translator:uav_readdatavalid -> wr_in_flags_s1_agent:m0_readdatavalid
	wire         wr_in_flags_s1_agent_m0_lock;                                              // wr_in_flags_s1_agent:m0_lock -> wr_in_flags_s1_translator:uav_lock
	wire  [31:0] wr_in_flags_s1_agent_m0_writedata;                                         // wr_in_flags_s1_agent:m0_writedata -> wr_in_flags_s1_translator:uav_writedata
	wire         wr_in_flags_s1_agent_m0_write;                                             // wr_in_flags_s1_agent:m0_write -> wr_in_flags_s1_translator:uav_write
	wire   [2:0] wr_in_flags_s1_agent_m0_burstcount;                                        // wr_in_flags_s1_agent:m0_burstcount -> wr_in_flags_s1_translator:uav_burstcount
	wire         wr_in_flags_s1_agent_rf_source_valid;                                      // wr_in_flags_s1_agent:rf_source_valid -> wr_in_flags_s1_agent_rsp_fifo:in_valid
	wire  [95:0] wr_in_flags_s1_agent_rf_source_data;                                       // wr_in_flags_s1_agent:rf_source_data -> wr_in_flags_s1_agent_rsp_fifo:in_data
	wire         wr_in_flags_s1_agent_rf_source_ready;                                      // wr_in_flags_s1_agent_rsp_fifo:in_ready -> wr_in_flags_s1_agent:rf_source_ready
	wire         wr_in_flags_s1_agent_rf_source_startofpacket;                              // wr_in_flags_s1_agent:rf_source_startofpacket -> wr_in_flags_s1_agent_rsp_fifo:in_startofpacket
	wire         wr_in_flags_s1_agent_rf_source_endofpacket;                                // wr_in_flags_s1_agent:rf_source_endofpacket -> wr_in_flags_s1_agent_rsp_fifo:in_endofpacket
	wire         wr_in_flags_s1_agent_rsp_fifo_out_valid;                                   // wr_in_flags_s1_agent_rsp_fifo:out_valid -> wr_in_flags_s1_agent:rf_sink_valid
	wire  [95:0] wr_in_flags_s1_agent_rsp_fifo_out_data;                                    // wr_in_flags_s1_agent_rsp_fifo:out_data -> wr_in_flags_s1_agent:rf_sink_data
	wire         wr_in_flags_s1_agent_rsp_fifo_out_ready;                                   // wr_in_flags_s1_agent:rf_sink_ready -> wr_in_flags_s1_agent_rsp_fifo:out_ready
	wire         wr_in_flags_s1_agent_rsp_fifo_out_startofpacket;                           // wr_in_flags_s1_agent_rsp_fifo:out_startofpacket -> wr_in_flags_s1_agent:rf_sink_startofpacket
	wire         wr_in_flags_s1_agent_rsp_fifo_out_endofpacket;                             // wr_in_flags_s1_agent_rsp_fifo:out_endofpacket -> wr_in_flags_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> wr_in_flags_s1_agent:cp_valid
	wire  [94:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> wr_in_flags_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // wr_in_flags_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> wr_in_flags_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> wr_in_flags_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> wr_in_flags_s1_agent:cp_endofpacket
	...
	wire         wr_data_pio_s1_agent_rp_valid;                                             // wr_data_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] wr_data_pio_s1_agent_rp_data;                                              // wr_data_pio_s1_agent:rp_data -> router_008:sink_data
	wire         wr_data_pio_s1_agent_rp_ready;                                             // router_008:sink_ready -> wr_data_pio_s1_agent:rp_ready
	wire         wr_data_pio_s1_agent_rp_startofpacket;                                     // wr_data_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         wr_data_pio_s1_agent_rp_endofpacket;                                       // wr_data_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         wr_addr_pio_s1_agent_rp_valid;                                             // wr_addr_pio_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] wr_addr_pio_s1_agent_rp_data;                                              // wr_addr_pio_s1_agent:rp_data -> router_009:sink_data
	wire         wr_addr_pio_s1_agent_rp_ready;                                             // router_009:sink_ready -> wr_addr_pio_s1_agent:rp_ready
	wire         wr_addr_pio_s1_agent_rp_startofpacket;                                     // wr_addr_pio_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         wr_addr_pio_s1_agent_rp_endofpacket;                                       // wr_addr_pio_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         wr_out_flags_s1_agent_rp_valid;                                            // wr_out_flags_s1_agent:rp_valid -> router_010:sink_valid
	wire  [94:0] wr_out_flags_s1_agent_rp_data;                                             // wr_out_flags_s1_agent:rp_data -> router_010:sink_data
	wire         wr_out_flags_s1_agent_rp_ready;                                            // router_010:sink_ready -> wr_out_flags_s1_agent:rp_ready
	wire         wr_out_flags_s1_agent_rp_startofpacket;                                    // wr_out_flags_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         wr_out_flags_s1_agent_rp_endofpacket;                                      // wr_out_flags_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         wr_in_flags_s1_agent_rp_valid;                                             // wr_in_flags_s1_agent:rp_valid -> router_011:sink_valid
	wire  [94:0] wr_in_flags_s1_agent_rp_data;                                              // wr_in_flags_s1_agent:rp_data -> router_011:sink_data
	wire         wr_in_flags_s1_agent_rp_ready;                                             // router_011:sink_ready -> wr_in_flags_s1_agent:rp_ready
	wire         wr_in_flags_s1_agent_rp_startofpacket;                                     // wr_in_flags_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         wr_in_flags_s1_agent_rp_endofpacket;                                       // wr_in_flags_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         wr_data_pio_s1_agent_rdata_fifo_src_valid;                                 // wr_data_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] wr_data_pio_s1_agent_rdata_fifo_src_data;                                  // wr_data_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         wr_data_pio_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_006:in_0_ready -> wr_data_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> wr_data_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> wr_data_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // wr_data_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> wr_data_pio_s1_agent:rdata_fifo_sink_error
	wire         wr_addr_pio_s1_agent_rdata_fifo_src_valid;                                 // wr_addr_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] wr_addr_pio_s1_agent_rdata_fifo_src_data;                                  // wr_addr_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         wr_addr_pio_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_007:in_0_ready -> wr_addr_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> wr_addr_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> wr_addr_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // wr_addr_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> wr_addr_pio_s1_agent:rdata_fifo_sink_error
	wire         wr_out_flags_s1_agent_rdata_fifo_src_valid;                                // wr_out_flags_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] wr_out_flags_s1_agent_rdata_fifo_src_data;                                 // wr_out_flags_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         wr_out_flags_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_008:in_0_ready -> wr_out_flags_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> wr_out_flags_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> wr_out_flags_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // wr_out_flags_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> wr_out_flags_s1_agent:rdata_fifo_sink_error
	wire         wr_in_flags_s1_agent_rdata_fifo_src_valid;                                 // wr_in_flags_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] wr_in_flags_s1_agent_rdata_fifo_src_data;                                  // wr_in_flags_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         wr_in_flags_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_009:in_0_ready -> wr_in_flags_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> wr_in_flags_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> wr_in_flags_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                         // wr_in_flags_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> wr_in_flags_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) wr_data_pio_s1_translator (
		.clk                    (clk_100_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (wr_data_pio_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (wr_data_pio_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (wr_data_pio_s1_agent_m0_read),            //                         .read
		.uav_write              (wr_data_pio_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (wr_data_pio_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (wr_data_pio_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (wr_data_pio_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (wr_data_pio_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (wr_data_pio_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (wr_data_pio_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (wr_data_pio_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (wr_data_pio_s1_address),                  //      avalon_anti_slave_0.address
		.av_write               (wr_data_pio_s1_write),                    //                         .write
		.av_readdata            (wr_data_pio_s1_readdata),                 //                         .readdata
		.av_writedata           (wr_data_pio_s1_writedata),                //                         .writedata
		.av_chipselect          (wr_data_pio_s1_chipselect),               //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) wr_addr_pio_s1_translator (
		.clk                    (clk_100_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (wr_addr_pio_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (wr_addr_pio_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (wr_addr_pio_s1_agent_m0_read),            //                         .read
		.uav_write              (wr_addr_pio_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (wr_addr_pio_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (wr_addr_pio_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (wr_addr_pio_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (wr_addr_pio_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (wr_addr_pio_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (wr_addr_pio_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (wr_addr_pio_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (wr_addr_pio_s1_address),                  //      avalon_anti_slave_0.address
		.av_write               (wr_addr_pio_s1_write),                    //                         .write
		.av_readdata            (wr_addr_pio_s1_readdata),                 //                         .readdata
		.av_writedata           (wr_addr_pio_s1_writedata),                //                         .writedata
		.av_chipselect          (wr_addr_pio_s1_chipselect),               //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) wr_out_flags_s1_translator (
		.clk                    (clk_100_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (wr_out_flags_s1_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (wr_out_flags_s1_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (wr_out_flags_s1_agent_m0_read),           //                         .read
		.uav_write              (wr_out_flags_s1_agent_m0_write),          //                         .write
		.uav_waitrequest        (wr_out_flags_s1_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (wr_out_flags_s1_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (wr_out_flags_s1_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (wr_out_flags_s1_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (wr_out_flags_s1_agent_m0_writedata),      //                         .writedata
		.uav_lock               (wr_out_flags_s1_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (wr_out_flags_s1_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (wr_out_flags_s1_address),                 //      avalon_anti_slave_0.address
		.av_write               (wr_out_flags_s1_write),                   //                         .write
		.av_readdata            (wr_out_flags_s1_readdata),                //                         .readdata
		.av_writedata           (wr_out_flags_s1_writedata),               //                         .writedata
		.av_chipselect          (wr_out_flags_s1_chipselect),              //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) wr_in_flags_s1_translator (
		.clk                    (clk_100_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (wr_in_flags_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (wr_in_flags_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (wr_in_flags_s1_agent_m0_read),            //                         .read
		.uav_write              (wr_in_flags_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (wr_in_flags_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (wr_in_flags_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (wr_in_flags_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (wr_in_flags_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (wr_in_flags_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (wr_in_flags_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (wr_in_flags_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (wr_in_flags_s1_address),                  //      avalon_anti_slave_0.address
		.av_readdata            (wr_in_flags_s1_readdata),                 //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
		.av_writedata           (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) wr_data_pio_s1_agent (
		.clk                     (clk_100_clk_clk),                                 //             clk.clk
		.reset                   (cpu_reset_n_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (wr_data_pio_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (wr_data_pio_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (wr_data_pio_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (wr_data_pio_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (wr_data_pio_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (wr_data_pio_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (wr_data_pio_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (wr_data_pio_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (wr_data_pio_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (wr_data_pio_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (wr_data_pio_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (wr_data_pio_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (wr_data_pio_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (wr_data_pio_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (wr_data_pio_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (wr_data_pio_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (wr_data_pio_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (wr_data_pio_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (wr_data_pio_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (wr_data_pio_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (wr_data_pio_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (wr_data_pio_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (wr_data_pio_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (wr_data_pio_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (wr_data_pio_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (wr_data_pio_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),               //                .error
		.rdata_fifo_src_ready    (wr_data_pio_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wr_data_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (wr_data_pio_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wr_data_pio_s1_agent_rsp_fifo (
		.clk               (clk_100_clk_clk),                                 //       clk.clk
		.reset             (cpu_reset_n_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (wr_data_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (wr_data_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (wr_data_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (wr_data_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (wr_data_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (wr_data_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (wr_data_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (wr_data_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (wr_data_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (wr_data_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) wr_addr_pio_s1_agent (
		.clk                     (clk_100_clk_clk),                                 //             clk.clk
		.reset                   (cpu_reset_n_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (wr_addr_pio_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (wr_addr_pio_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (wr_addr_pio_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (wr_addr_pio_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (wr_addr_pio_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (wr_addr_pio_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (wr_addr_pio_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (wr_addr_pio_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (wr_addr_pio_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (wr_addr_pio_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (wr_addr_pio_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (wr_addr_pio_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (wr_addr_pio_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (wr_addr_pio_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (wr_addr_pio_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (wr_addr_pio_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (wr_addr_pio_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (wr_addr_pio_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (wr_addr_pio_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (wr_addr_pio_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (wr_addr_pio_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (wr_addr_pio_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (wr_addr_pio_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (wr_addr_pio_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (wr_addr_pio_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (wr_addr_pio_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),               //                .error
		.rdata_fifo_src_ready    (wr_addr_pio_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wr_addr_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (wr_addr_pio_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wr_addr_pio_s1_agent_rsp_fifo (
		.clk               (clk_100_clk_clk),                                 //       clk.clk
		.reset             (cpu_reset_n_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (wr_addr_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (wr_addr_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (wr_addr_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (wr_addr_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (wr_addr_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (wr_addr_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (wr_addr_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (wr_addr_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (wr_addr_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (wr_addr_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) wr_out_flags_s1_agent (
		.clk                     (clk_100_clk_clk),                                  //             clk.clk
		.reset                   (cpu_reset_n_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (wr_out_flags_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (wr_out_flags_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (wr_out_flags_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (wr_out_flags_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (wr_out_flags_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (wr_out_flags_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (wr_out_flags_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (wr_out_flags_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (wr_out_flags_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (wr_out_flags_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (wr_out_flags_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (wr_out_flags_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (wr_out_flags_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (wr_out_flags_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (wr_out_flags_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (wr_out_flags_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (wr_out_flags_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (wr_out_flags_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (wr_out_flags_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (wr_out_flags_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (wr_out_flags_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (wr_out_flags_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (wr_out_flags_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (wr_out_flags_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (wr_out_flags_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (wr_out_flags_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                //                .error
		.rdata_fifo_src_ready    (wr_out_flags_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wr_out_flags_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (wr_out_flags_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wr_out_flags_s1_agent_rsp_fifo (
		.clk               (clk_100_clk_clk),                                  //       clk.clk
		.reset             (cpu_reset_n_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (wr_out_flags_s1_agent_rf_source_data),             //        in.data
		.in_valid          (wr_out_flags_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (wr_out_flags_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (wr_out_flags_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (wr_out_flags_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (wr_out_flags_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (wr_out_flags_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (wr_out_flags_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (wr_out_flags_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (wr_out_flags_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) wr_in_flags_s1_agent (
		.clk                     (clk_100_clk_clk),                                 //             clk.clk
		.reset                   (cpu_reset_n_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (wr_in_flags_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (wr_in_flags_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (wr_in_flags_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (wr_in_flags_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (wr_in_flags_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (wr_in_flags_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (wr_in_flags_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (wr_in_flags_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (wr_in_flags_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (wr_in_flags_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (wr_in_flags_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (wr_in_flags_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (wr_in_flags_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (wr_in_flags_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (wr_in_flags_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (wr_in_flags_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (wr_in_flags_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (wr_in_flags_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (wr_in_flags_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (wr_in_flags_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (wr_in_flags_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (wr_in_flags_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (wr_in_flags_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (wr_in_flags_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (wr_in_flags_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (wr_in_flags_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),               //                .error
		.rdata_fifo_src_ready    (wr_in_flags_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wr_in_flags_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (wr_in_flags_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wr_in_flags_s1_agent_rsp_fifo (
		.clk               (clk_100_clk_clk),                                 //       clk.clk
		.reset             (cpu_reset_n_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (wr_in_flags_s1_agent_rf_source_data),             //        in.data
		.in_valid          (wr_in_flags_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (wr_in_flags_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (wr_in_flags_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (wr_in_flags_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (wr_in_flags_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (wr_in_flags_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (wr_in_flags_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (wr_in_flags_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (wr_in_flags_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	cpu_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (wr_data_pio_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (wr_data_pio_s1_agent_rp_valid),           //          .valid
		.sink_data          (wr_data_pio_s1_agent_rp_data),            //          .data
		.sink_startofpacket (wr_data_pio_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (wr_data_pio_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_100_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (wr_addr_pio_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (wr_addr_pio_s1_agent_rp_valid),           //          .valid
		.sink_data          (wr_addr_pio_s1_agent_rp_data),            //          .data
		.sink_startofpacket (wr_addr_pio_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (wr_addr_pio_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_100_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (wr_out_flags_s1_agent_rp_ready),          //      sink.ready
		.sink_valid         (wr_out_flags_s1_agent_rp_valid),          //          .valid
		.sink_data          (wr_out_flags_s1_agent_rp_data),           //          .data
		.sink_startofpacket (wr_out_flags_s1_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (wr_out_flags_s1_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_100_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_router_002 router_011 (
		.sink_ready         (wr_in_flags_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (wr_in_flags_s1_agent_rp_valid),           //          .valid
		.sink_data          (wr_in_flags_s1_agent_rp_data),            //          .data
		.sink_startofpacket (wr_in_flags_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (wr_in_flags_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_100_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_100_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_n_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (wr_data_pio_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (wr_data_pio_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (wr_data_pio_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_100_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_n_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (wr_addr_pio_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (wr_addr_pio_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (wr_addr_pio_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_100_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_n_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (wr_out_flags_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (wr_out_flags_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (wr_out_flags_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_100_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_n_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (wr_in_flags_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (wr_in_flags_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (wr_in_flags_s1_agent_rdata_fifo_src_ready), //         .ready
